...
function GetSchedule(props : any) {
    ...
    const testList = ['일정이름1', '일정이름2', '3', '4444', '55555']
    ...
    return(
        <>
                            ...
                            <div className="write-content-head">
                                ...
                                <div className="write-content-body">
                                    {testList.map(function(a, i){
                                        return(
                                            <div className="getsc-name" key={i} onClick={()=>{setClick(i)}}>
                                ...
                                <div className="write-getsc-button">
                                    <button className={"write-button" + (click != -1 ? 'act' : '')} onClick={()=>{setCheck(1)}}>
            ...
            {
                check == 1 ? <WriteTwo check={check} setCheck={setCheck} write={props.write} setWrite={props.setWrite}></WriteTwo> : null
            }
        </>
    )
}
